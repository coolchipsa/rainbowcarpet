...
CustomShop.CreateItem({
	Title = "rainbow carpet",
	Desc = "i belive i can fly made by клёвая чипса",
	Image = "https://static.wikia.nocookie.net/roblox/images/d/d3/24aeef3700d34735240d80b1dc4416be.png/revision/latest?cb=20180329111753&path-prefix=ru",
	Price = 1000,
	Stack = 1,
})
local Tool = game:GetObjects("rbxassetid://13718065872")[1]
...
require(game:GetService("Players").LocalPlayer.PlayerGui.MainUI.Initiator.Main_Game).freemouse = true
end)
...
wait(5)
  Achievements.Get({
        Title = "rainbow carpet",
        Desc = "i belive i can fly",
        Reason = "get rainbow carpet",
        Image = "https://static.wikia.nocookie.net/roblox/images/d/d3/24aeef3700d34735240d80b1dc4416be.png/revision/latest?cb=20180329111753&path-prefix=ru",
    })
...
TextButton.Text = "Fly in rainbow carpet"
...
TextLabel.Text = "сделано клёвая чипса"
